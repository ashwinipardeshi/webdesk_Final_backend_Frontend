...
namespace MasterWebAPI.Data;

public partial class MasterDevFinalDbContext : DbContext
{
    protected readonly IConfiguration Configuration;

    public MasterDevFinalDbContext(DbContextOptions<MasterDevFinalDbContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    {
        options.UseSqlServer(Configuration.GetConnectionString("MasterWebAPICon"));
    }
