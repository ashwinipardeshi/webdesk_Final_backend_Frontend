...
{
    public class TalukaGMasterUnitTestCases
    {
        private readonly Mock<ITalukaService> _mockService;
        private readonly TalukaGMasterController _controller;

        public TalukaGMasterUnitTestCases()
        {
            _mockService = new Mock<ITalukaService>();
            _controller = new TalukaGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new TalukaGMasterVM()
            {
