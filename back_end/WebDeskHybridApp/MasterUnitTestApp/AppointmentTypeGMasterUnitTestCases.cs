...
{
    public class AppointmentTypeGMasterUnitTestCases
    {
        private readonly Mock<IAppointmentTypeService> _mockService;
        private readonly AppointmentTypeGMasterController _controller;

        public AppointmentTypeGMasterUnitTestCases()
        {
            _mockService = new Mock<IAppointmentTypeService>();
            _controller = new AppointmentTypeGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new AppointmentTypeGMasterVM()
            {
