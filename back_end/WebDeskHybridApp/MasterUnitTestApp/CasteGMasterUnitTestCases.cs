...
{
    public class CasteGMasterUnitTestCases
    {
        private readonly Mock<ICasteService> _mockService;
        private readonly CasteGMasterController _controller;

        public CasteGMasterUnitTestCases()
        {
            _mockService = new Mock<ICasteService>();
            _controller = new CasteGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new CasteGMasterVM()
            {
