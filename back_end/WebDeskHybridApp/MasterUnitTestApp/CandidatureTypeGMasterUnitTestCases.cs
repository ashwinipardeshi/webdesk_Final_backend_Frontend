...
{
    public class CandidatureTypeGMasterUnitTestCases
    {
        private readonly Mock<ICandidatureTypeService> _mockService;
        private readonly CandidatureTypeGMasterController _controller;

        public CandidatureTypeGMasterUnitTestCases()
        {
            _mockService = new Mock<ICandidatureTypeService>();
            _controller = new CandidatureTypeGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new CandidatureTypeGMasterVM()
            {
