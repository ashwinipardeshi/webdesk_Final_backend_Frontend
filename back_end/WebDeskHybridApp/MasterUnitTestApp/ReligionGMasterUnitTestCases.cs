...
{
    public class ReligionGMasterUnitTestCases
    {
        private readonly Mock<IReligionService> _mockService;
        private readonly ReligionGMasterController _controller;

        public ReligionGMasterUnitTestCases()
        {
            _mockService = new Mock<IReligionService>();
            _controller = new ReligionGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new ReligionGMasterVM()
            {
