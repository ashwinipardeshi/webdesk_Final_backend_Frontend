...
{
    public class StateGMasterUnitTestCases
    {
        private readonly Mock<IStateService> _mockService;
        private readonly StateGMasterController _controller;

        public StateGMasterUnitTestCases()
        {
            _mockService = new Mock<IStateService>();
            _controller = new StateGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new StateGMasterVM()
            {
