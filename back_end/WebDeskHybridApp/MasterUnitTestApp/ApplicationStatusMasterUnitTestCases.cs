...
{
    public class ApplicationStatusMasterUnitTestCases
    {
        private readonly Mock<IApplicationStatusService> _mockService;
        private readonly ApplicationStatusMasterController _controller;

        public ApplicationStatusMasterUnitTestCases()
        {
            _mockService = new Mock<IApplicationStatusService>();
            _controller = new ApplicationStatusMasterController(_mockService.Object);
        }
        [SetUp]
        public void Setup()
        {
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new ApplicationStatusMasterVM()
            {
