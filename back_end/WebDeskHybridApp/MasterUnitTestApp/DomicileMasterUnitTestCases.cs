...
{
    public class DomicileMasterUnitTestCases
    {
        private readonly Mock<IDomicileService> _mockService;
        private readonly DomicileGMasterController _controller;

        public DomicileMasterUnitTestCases()
        {
            _mockService = new Mock<IDomicileService>();
            _controller = new DomicileGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new DomicileGMasterVM()
            {
