...
{
    public class MotherTongueGMasterUnitTestCases
    {
        private readonly Mock<IMotherTongueService> _mockService;
        private readonly MotherTongueGMasterController _controller;

        public MotherTongueGMasterUnitTestCases()
        {
            _mockService = new Mock<IMotherTongueService>();
            _controller = new MotherTongueGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new MotherTongueGMasterVM()
            {
