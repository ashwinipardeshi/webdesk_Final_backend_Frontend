...
{
    public class EmployeeTypeGMasterUnitTestCases
    {
        private readonly Mock<IEmployeeTypeService> _mockService;
        private readonly EmployeeTypeGMasterController _controller;

        public EmployeeTypeGMasterUnitTestCases()
        {
            _mockService = new Mock<IEmployeeTypeService>();
            _controller = new EmployeeTypeGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new EmployeeTypeGMasterVM()
            {
