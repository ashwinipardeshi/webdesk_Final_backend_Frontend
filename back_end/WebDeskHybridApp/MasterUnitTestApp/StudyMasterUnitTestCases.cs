...
{
    public class StudyMasterUnitTestCases
    {
        private readonly Mock<IStudyService> _mockService;
        private readonly StudyMasterController _controller;

        public StudyMasterUnitTestCases()
        {
            _mockService = new Mock<IStudyService>();
            _controller = new StudyMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new StudyMasterVM()
            {
