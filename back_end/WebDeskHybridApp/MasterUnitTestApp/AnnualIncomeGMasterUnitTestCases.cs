...
{
    public class AnnualIncomeGMasterUnitTestCases
    {
        private readonly Mock<IAnnualIncomeService> _mockService;
        private readonly AnnualIncomeGMasterController _controller;

        public AnnualIncomeGMasterUnitTestCases()
        {
            _mockService = new Mock<IAnnualIncomeService>();
            _controller = new AnnualIncomeGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new AnnualIncomeGMasterVM()
            {
