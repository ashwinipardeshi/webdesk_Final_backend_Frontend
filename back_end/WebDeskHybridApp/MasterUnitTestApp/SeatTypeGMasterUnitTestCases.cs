...
{
    public class SeatTypeGMasterUnitTestCases
    {
        private readonly Mock<ISeatTypeService> _mockService;
        private readonly SeatTypeMasterController _controller;

        public SeatTypeGMasterUnitTestCases()
        {
            _mockService = new Mock<ISeatTypeService>();
            _controller = new SeatTypeMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new SeatTypeMasterVM()
            {
