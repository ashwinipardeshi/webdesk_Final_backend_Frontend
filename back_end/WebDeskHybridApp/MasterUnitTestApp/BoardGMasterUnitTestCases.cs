...
{
    public class BoardGMasterUnitTestCases
    {
        private readonly Mock<IBoardService> _mockService;
        private readonly BoardGMasterController _controller;

        public BoardGMasterUnitTestCases()
        {
            _mockService = new Mock<IBoardService>();
            _controller = new BoardGMasterController(_mockService.Object);
        }
        ...
        {
            var res = (ObjectResult)await _controller.Insert(new BoardGMasterVM()
            {
