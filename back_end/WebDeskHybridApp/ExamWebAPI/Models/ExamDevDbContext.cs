...
public partial class ExamDevDbContext : DbContext
{
    public ExamDevDbContext()
    {
    }

    public ExamDevDbContext(DbContextOptions<ExamDevDbContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=103.172.151.211,1455;Database=ExamDevDB;User Id=devuser;password=USg1#E729D19L;TrustServerCertificate=True;");
