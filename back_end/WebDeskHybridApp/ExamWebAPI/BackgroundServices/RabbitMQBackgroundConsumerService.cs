...
namespace ExamWebAPI.BackgroundServices
{
    ...
    //{
        ...
        //        var productDetails = JsonConvert.DeserializeObject<CountryGMasterVM>(message);

        //        //Stored Offer Details into the Database
        //        using (var scope = serviceScopeFactory.CreateScope())
        //        {
        //            var _dbContext = scope.ServiceProvider.GetRequiredService<ExamDevFinalDbContext>();
