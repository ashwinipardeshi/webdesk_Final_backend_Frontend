...
namespace SaaSAppAPI.Data
{
    public partial class SaaSdevDbFinalContext : DbContext
    {
        protected readonly IConfiguration Configuration;

        public SaaSdevDbFinalContext(DbContextOptions<SaaSdevDbFinalContext> options, IConfiguration configuration)
            : base(options)
        {
        ...
        {
            options.UseSqlServer(Configuration.GetConnectionString("SaaSAppAPICon"));
        }


        #region SaaSAppAPIData
