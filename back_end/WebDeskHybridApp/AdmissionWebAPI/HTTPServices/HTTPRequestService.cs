...
namespace AdmissionWebAPI.HTTPServices
{
    public class HTTPRequestService : IHTTPRequestService
    {
        ...
        //public async Task<CountryGMasterVM> HTTPGetRequestCallNew(string apiurl)
        //{
        //    using (var httpClient = new HttpClient())
        //    {
        //        using (var response = await httpClient.GetAsync(apiurl))
        ...
        //            {
        //                string apiResponse = await response.Content.ReadAsStringAsync();
        //                return JsonConvert.DeserializeObject<APIResponse<CountryGMasterVM>>(apiResponse).result;
        //            }
        //            return null;
        //        }
        //    }
