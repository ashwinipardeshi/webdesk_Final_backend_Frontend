...
public partial class AdmissionDevDbContext : DbContext
{
    public AdmissionDevDbContext()
    {
    }

    public AdmissionDevDbContext(DbContextOptions<AdmissionDevDbContext> options)
        : base(options)
    {
    }
