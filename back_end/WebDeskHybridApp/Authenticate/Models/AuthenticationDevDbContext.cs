...
public partial class AuthenticationDevDbContext : DbContext
{
    public AuthenticationDevDbContext()
    {
    }

    public AuthenticationDevDbContext(DbContextOptions<AuthenticationDevDbContext> options)
        : base(options)
    {
    }
