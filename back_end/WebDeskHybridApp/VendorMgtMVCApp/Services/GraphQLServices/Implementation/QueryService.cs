...
namespace VendorMgtMVCApp.Services.GraphQLServices.Implementation
{
    public class QueryService : IQueryService
    {
        ...
        public async Task<List<T>> ExceuteQueryReturnListAsyn<T>(string graphQLQueryType, string completeQueryString)
        {
            try
            {
        ...
        public async Task<T> ExceuteQueryAsyn<T>(string graphQLQueryType, string completeQueryString)
        {
            try
            {
                var request = new GraphQLRequest
