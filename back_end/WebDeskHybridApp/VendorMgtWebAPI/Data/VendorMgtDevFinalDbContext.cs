...
public partial class VendorMgtDevFinalDbContext : DbContext
{

    protected readonly IConfiguration Configuration;
    public VendorMgtDevFinalDbContext(DbContextOptions<VendorMgtDevFinalDbContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    {
        options.UseSqlServer(Configuration.GetConnectionString("VendorMgtAPICon"));
    }
