...
import { ONLINE_USER_MENUITEMS } from "./OnlineUserMenu";
import { OFFLINE_USER_MENUITEMS } from "./OfflineUserMenu";
import { STAFF_MENUITEMS } from "./StaffMenu";
import Scrollbars from "react-custom-scrollbars";
import { NavLink, useNavigate } from "react-router-dom";
import { useLocation } from "react-router-dom";
import { getRoleId, getToken } from "../../store/Authentication/authentication";
import { ADMIN, STAFF, ONLINE_USER, OFFLINE_USER } from "../../constant/roleIds";
...
const Sidebar = () => {
  ...
  useEffect(() => {
    roleId === ONLINE_USER ? setMenuitems(ONLINE_USER_MENUITEMS) :
      roleId === OFFLINE_USER ? setMenuitems(OFFLINE_USER_MENUITEMS) :
        roleId === STAFF ? setMenuitems(STAFF_MENUITEMS) : setMenuitems(MENUITEMS)
  }, [roleId])
