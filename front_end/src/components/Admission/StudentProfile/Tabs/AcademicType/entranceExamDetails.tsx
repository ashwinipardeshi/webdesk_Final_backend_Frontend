...
const EntranceExamDetails: FC = () => {
  ...
  const [previousAcademicDetails, setPreviousAcademicDetails] = React.useState(offlineStudentData.offlineEntranceExamDetailsVMList);
  ...
  useEffect(() => {
    if (offlineStudentData) {
      const fetchStudentData = async () => {
        try {
          setRows(offlineStudentData.offlineEntranceExamDetailsVMList);
  ...
  const processRowUpdate = (newRow: GridRowModel) => {
    ...
    try {
      if (actionType === "EDIT") {
        finaldata = offlineStudentData.offlineEntranceExamDetailsVMList.map(
          (obj: any) => {
            if (obj.id === newRow.id) {
              return {
                ...obj,
        ...
        finaldata = [
          ...
          ...offlineStudentData.offlineEntranceExamDetailsVMList,
        ];
      }
      const request = {
        ...
        offlineEntranceExamDetailsVMList: finaldata,
      };
