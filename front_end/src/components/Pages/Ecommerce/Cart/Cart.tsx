...
const Cart = () => {
  ...
  const remove = (item: any) => {
    dispatch(actions.cartreducer(item));
  };
  const send = (e: any) => {
    // console.log(e);
    dispatch(actions.cartreducer(e));
  };
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  >
                                    ...
                                    <span className="qty">
                                      <div className="mt-2">{item.qnty}</div>
                                    </span>
                                    <Button
                                      variant=""
                                ...
                                <td className="text-center">
                                  <span
                                    className={`badge bg-${item.stockbg} p-1`}
                                  >
                                    {item.stock}
                                  </span>
                                </td>
            ...
            <Card.Footer>
              <div className="shopping-cart-footer bd-0">
                <div className="column">
                  ...
                  >
                    <i className="fe fe-corner-up-left  mx-2"></i>Back to
                    Shopping
                  </Link>
                </div>
                <div className="column">
                  <Link
                    ...
                    to={`${process.env.PUBLIC_URL}/pages/e-commerce/cart`}
                  >
