    ...
    <>
      ...
      <div>
        ...
        <MastersHeader
          ...
          BreadcrumSubTitle={"Stream Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStreamData ? getByIDStreamData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStreamData ? getByIDStreamData.description : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDStreamData && getByIDStreamData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDStreamData && getByIDStreamData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStreamData &&
                getByIDStreamData.createdDate !== undefined &&
                getByIDStreamData.createdDate !== null
                  ? moment(new Date(getByIDStreamData.createdDate))
                      .utc(true)
                      .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStreamData && getByIDStreamData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStreamData &&
                getByIDStreamData &&
                getByIDStreamData.updatedDate
                  ? moment(new Date(getByIDStreamData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_TIME_FORMAT)
                  : ""}
