...
const StreamList: FC = () => {
    const { data: Streams, setData: setUser } = StreamHook(true);
    ...
    const getDeleteStreamData = useSelector(getDeleteStreamMaster);
    ...
    const handleActionClick = (event: any, rowData: any, type: string) => {
        ...
        type === "View"
            ? navigate(`/stream/view/${rowData.id}`)
            : type === "Edit"
                ? navigate(`/stream/update/${rowData.id}`)
                : type === "Add"
                    ? navigate("/stream/add")
                    : setOpenDialog(true);
    };
    ...
    const deleteStreamClick = () => {
        if (selectedRowData) {
            dispatch(actions.loadDeleteStreamMaster(selectedRowData));
            setOpenDialog(false);
        }
    };
    ...
    return (
        <>
            ...
            <DeleteConfirmation
                ...
                actionToggleDeleteDialog={deleteStreamClick}
