  ...
  return (
    <>
      ...
      <div>
        {/* <!-- breadcrumb --> */}
        <MastersHeader
          title={"SMTP Config Details"}
          BreadcrumbTitle={"SMTP Config"}
          BreadcrumSubTitle={"SMTP Config Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDSMTPConfigData ? getByIDSMTPConfigData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDSMTPConfigData && getByIDSMTPConfigData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDSMTPConfigData && getByIDSMTPConfigData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                ...
                getByIDSMTPConfigData.createdDate !== undefined &&
                getByIDSMTPConfigData.createdDate !== null
                  ? moment(new Date(getByIDSMTPConfigData.createdDate))
                      .utc(true)
                      .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDSMTPConfigData && getByIDSMTPConfigData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDSMTPConfigData &&
                getByIDSMTPConfigData &&
                getByIDSMTPConfigData.updatedDate
                  ? moment(new Date(getByIDSMTPConfigData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_TIME_FORMAT)
                  : ""}
            ...
            >
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={navigateToSMTPConfigList}
              >
                Back
              </Button>
            </Grid>
