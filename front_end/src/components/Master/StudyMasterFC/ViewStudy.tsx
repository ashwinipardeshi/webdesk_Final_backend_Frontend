...
import { actions, getbyIdStudyMaster } from "../../../store/Master/studyMaster";
    ...
    <>
      ...
      <div>
        <MastersHeader
          ...
          BreadcrumSubTitle={"Study Details"}
        />
      </div>
      <Paper elevation={3}>
        <Box p={2} pt={0}>
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStudyData ? getByIDStudyData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDStudyData && getByIDStudyData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDStudyData && getByIDStudyData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStudyData &&
                getByIDStudyData.createdDate !== undefined &&
                getByIDStudyData.createdDate !== null
                  ? moment(new Date(getByIDStudyData.createdDate))
                      .utc(true)
                      .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStudyData && getByIDStudyData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDStudyData &&
                getByIDStudyData &&
                getByIDStudyData.updatedDate
                  ? moment(new Date(getByIDStudyData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_TIME_FORMAT)
                  : ""}
