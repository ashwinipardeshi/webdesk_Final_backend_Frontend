...
import { actions, getbyIdBankMaster } from "../../../store/Master/bankMaster";
    ...
    <>
      ...
      <div>
        ...
        <MastersHeader
          ...
          BreadcrumSubTitle={"Bank Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDBankData ? getByIDBankData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDBankData && getByIDBankData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDBankData && getByIDBankData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDBankData &&
                getByIDBankData.createdDate !== undefined &&
                getByIDBankData.createdDate !== null
                  ? moment(new Date(getByIDBankData.createdDate))
                      .utc(true)
                      .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDBankData && getByIDBankData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDBankData &&
                getByIDBankData &&
                getByIDBankData.updatedDate
                  ? moment(new Date(getByIDBankData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_TIME_FORMAT)
                  : ""}
