...
import { BankHook } from "../../../hooks/masters/bankHooks";
...
const BankList: FC = () => {
    const { bankdata: bankdatas, setBankData: setUser } = BankHook(true);
    ...
    const getDeleteBankData = useSelector(getDeleteBankMaster);
    ...
    const handleActionClick = (event: any, rowData: any, type: string) => {
        ...
        type === "View"
            ? navigate(`/bank/view/${rowData.id}`)
            : type === "Edit"
                ? navigate(`/bank/update/${rowData.id}`)
                : type === "Add"
                    ? navigate("/bank/add")
                    : setOpenDialog(true);
    };
    ...
    const deleteBankClick = () => {
        if (selectedRowData) {
            dispatch(actions.loadDeleteBankMaster(selectedRowData));
            setOpenDialog(false);
        }
    };
    ...
    return (
        <>
            ...
            <DeleteConfirmation
                ...
                actionToggleDeleteDialog={deleteBankClick}
