    ...
    <>
      <div>
        ...
        <MastersHeader
          ...
          BreadcrumSubTitle={"Caste Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCasteData ? getByIDCasteData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDCasteData && getByIDCasteData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDCasteData && getByIDCasteData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCasteData &&
                  getByIDCasteData.createdDate !== undefined &&
                  getByIDCasteData.createdDate !== null
                  ? moment(new Date(getByIDCasteData.createdDate))
                    .utc(true)
                    .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCasteData && getByIDCasteData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCasteData &&
                  getByIDCasteData &&
                  getByIDCasteData.updatedDate
                  ? moment(new Date(getByIDCasteData.updatedDate))
                    .utc(true)
                    .local()
                    .format(DATE_TIME_FORMAT)
                  : ""}
