...
import { BoardHook } from "../../../hooks/globalMasters/boardHooks";
import DeleteConfirmation from "../../../layouts/deleteConfirmation";
import { selectStatus } from "../../../store/loader";
import Loader from "../../../shade/Loaders/Loaders";
import {
    actions,
    getDeleteBoardMaster,
...
const BoardList: FC = () => {
    const { data: boardlists, setData: setUser } = BoardHook(true);
    ...
    const getDeleteBoardData = useSelector(getDeleteBoardMaster);
    ...
    const handleActionClick = (event: any, rowData: any, type: string) => {
        ...
        type === "View"
            ...
            : type === "Edit"
                ? navigate(`/board/update/${rowData.id}`)
                : type === "Add"
                    ? navigate("/board/add")
                    : setOpenDialog(true);
    };
    ...
    const deleteBoardClick = () => {
        if (selectedRowData) {
            dispatch(actions.loadDeleteBoardMaster(selectedRowData));
            setOpenDialog(false);
        }
    };
    ...
    return (
        <>
            ...
            <DeleteConfirmation
                ...
                actionToggleDeleteDialog={deleteBoardClick}
