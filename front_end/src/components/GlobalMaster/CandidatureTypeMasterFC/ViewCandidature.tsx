  ...
  return (
    <>
      <div>
        {/* <!-- breadcrumb --> */}
        <MastersHeader
          title={"CandidatureType Details"}
          BreadcrumbTitle={"CountCandidatureTypery"}
          BreadcrumSubTitle={"CandidatureType Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCandidatureTypeData ? getByIDCandidatureTypeData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDCandidatureTypeData && getByIDCandidatureTypeData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDCandidatureTypeData && getByIDCandidatureTypeData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                ...
                getByIDCandidatureTypeData.createdDate !== undefined &&
                getByIDCandidatureTypeData.createdDate !== null
                  ? moment(new Date(getByIDCandidatureTypeData.createdDate))
                      .utc(true)
                      .local()
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCandidatureTypeData && getByIDCandidatureTypeData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDCandidatureTypeData &&
                getByIDCandidatureTypeData &&
                getByIDCandidatureTypeData.updatedDate
                  ? moment(new Date(getByIDCandidatureTypeData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_TIME_FORMAT)
                  : ""}
