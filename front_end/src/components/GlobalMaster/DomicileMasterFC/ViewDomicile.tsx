    ...
    {loaderStatus === "loading" && <Loader />}
      <div>
        ...
        <MastersHeader
          ...
          BreadcrumSubTitle={"Domicile Details"}
        />
        {/* <!-- /breadcrumb --> */}
      </div>
      <Paper elevation={3}>
          ...
          <Grid container mt={0} spacing={2}>
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDDomicileData ? getByIDDomicileData.name : ""}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDDomicileData && getByIDDomicileData.isActive
                  ? "Active"
                  : "InActive"}
              </span>
            </Grid>
            ...
            >
              {" "}
              <span className={classes.labelTitle}>
                {getByIDDomicileData && getByIDDomicileData.createdBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDDomicileData &&
                getByIDDomicileData.createdDate !== undefined &&
                getByIDDomicileData.createdDate !== null
                  ? moment(new Date(getByIDDomicileData.createdDate))
                      .utc(true)
                      .local()
                      .format("MM/DD/YYYY")
                  : ""}
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDDomicileData && getByIDDomicileData.updatedBy}
              </span>
            </Grid>
            <Grid
              item
            ...
            >
              <span className={classes.labelTitle}>
                {getByIDDomicileData &&
                getByIDDomicileData &&
                getByIDDomicileData.updatedDate
                  ? moment(new Date(getByIDDomicileData.updatedDate))
                      .utc(true)
                      .local()
                      .format(DATE_FORMAT)
                  : ""}
