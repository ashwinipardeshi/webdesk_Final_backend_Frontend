...
import { DistrictHook } from "../../../hooks/globalMasters/districtHook";
import DeleteConfirmation from "../../../layouts/deleteConfirmation";
import { selectStatus } from "../../../store/loader";
import Loader from "../../../shade/Loaders/Loaders";
import {
    actions,
    getDeleteDistrictMaster
...
const DistrictList: FC = () => {
    const { data: districts, setData: setUser } = DistrictHook(true);
    ...
    const getDeleteDistrictData = useSelector(getDeleteDistrictMaster);
    ...
    const handleActionClick = (event: any, rowData: any, type: string) => {
        ...
        type === "View"
            ? navigate(`/district/view/${rowData.id}`)
            : type === "Edit"
                ? navigate(`/district/update/${rowData.id}`)
                : type === "Add"
                    ? navigate("/district/add")
                    : setOpenDialog(true);
    };
    ...
    const deleteDistrictClick = () => {
        if (selectedRowData) {
            dispatch(actions.loadDeleteDistrictMaster(selectedRowData));
            setOpenDialog(false);
        }
    };
        ...
        <>
            ...
            <div>
                ...
                <MastersHeader
                    ...
                    BreadcrumSubTitle={"District List"}
                />
                {/* <!-- /breadcrumb --> */}
            </div>
            <Paper elevation={3}>
            ...
            <DeleteConfirmation
                ...
                actionToggleDeleteDialog={deleteDistrictClick}
