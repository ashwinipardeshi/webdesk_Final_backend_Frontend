...
import { StateHook } from "../../../hooks/globalMasters/stateHooks";
import DeleteConfirmation from "../../../layouts/deleteConfirmation";
import { selectStatus } from "../../../store/loader";
import Loader from "../../../shade/Loaders/Loaders";
import {
    actions,
    getDeleteStateMaster
...
const StateList: FC = () => {
    const { data: states, setData: setUser } = StateHook(true);
    ...
    const getDeleteStateData = useSelector(getDeleteStateMaster);
    ...
    const handleActionClick = (event: any, rowData: any, type: string) => {
        ...
        type === "View"
            ? navigate(`/state/view/${rowData.id}`)
            : type === "Edit"
                ? navigate(`/state/update/${rowData.id}`)
                : type === "Add"
                    ? navigate("/state/add")
                    : setOpenDialog(true);
    };
    ...
    const deleteStateClick = () => {
        if (selectedRowData) {
            dispatch(actions.loadDeleteStateMaster(selectedRowData));
            setOpenDialog(false);
        }
    };
    ...
    return (
        <>
            ...
            <DeleteConfirmation
                ...
                actionToggleDeleteDialog={deleteStateClick}
