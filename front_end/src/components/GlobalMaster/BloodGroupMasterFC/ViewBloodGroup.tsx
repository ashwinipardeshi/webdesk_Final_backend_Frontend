...
import { actions, getbyIdBloodGroupMaster } from "../../../store/GlobalMaster/bloodGroupMaster";
        ...
        <>
            ...
            <div>
                <MastersHeader
                    ...
                    BreadcrumSubTitle={"Blood Group Details"}
                />
            </div>
            <Paper elevation={3}>
                <Box p={2} pt={0}>
                    <Grid container mt={0} spacing={2}>
                        ...
                        >
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData ? getByIDBloodGroupData.name : ""}
                            </span>
                        </Grid>
                        <Grid
                            item
                        ...
                        >
                            {" "}
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData && getByIDBloodGroupData.isActive
                                    ? "Active"
                                    : "InActive"}
                            </span>
                        </Grid>
                        ...
                        >
                            {" "}
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData && getByIDBloodGroupData.createdBy}
                            </span>
                        </Grid>
                        <Grid
                            item
                        ...
                        >
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData &&
                                    getByIDBloodGroupData.createdDate !== undefined &&
                                    getByIDBloodGroupData.createdDate !== null
                                    ? moment(new Date(getByIDBloodGroupData.createdDate))
                                        .utc(true)
                                        .local()
                        ...
                        >
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData && getByIDBloodGroupData.updatedBy}
                            </span>
                        </Grid>
                        <Grid
                            item
                        ...
                        >
                            <span className={classes.labelTitle}>
                                {getByIDBloodGroupData &&
                                    getByIDBloodGroupData &&
                                    getByIDBloodGroupData.updatedDate
                                    ? moment(new Date(getByIDBloodGroupData.updatedDate))
                                        .utc(true)
                                        .local()
                                        .format(DATE_TIME_FORMAT)
                                    : ""}
                        ...
                        >
                            ...
                            <Button
                                variant="contained"
                                color="primary"
                                onClick={navigateToBloodGroupList}
                            >
                                Back
                            </Button>
                        </Grid>
